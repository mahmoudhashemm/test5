...
``` bash
curl -s https://raw.githubusercontent.com/mahmoudhashemm/odoo-19-N/main/run.sh | sudo bash -s elmostafa-19 10015 20015 8069 8072 10.0.0.16/29 10.0.0.17 10.0.0.18 10.0.0.19 elmostafa-19
```
